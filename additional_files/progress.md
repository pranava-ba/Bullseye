...
| Category        | Issue                                                  | Fix / Improvement                                       |
| --------------- | ------------------------------------------------------ | ------------------------------------------------------- |
...
| Constraint      | Token limits slowed progress                           | Used multiple Claude accounts with logs                 |

---

If you want next level polish, I can:

* Convert this into a **timeline-style table (day-wise progress)**
* Or add a **“Impact / Outcome” column** (great for resume/portfolio)
